...
public:
	MovieData() = default;
	MovieData(const std::string& title, float runTimeInMinutes, const std::vector<std::string>& genres, const std::string& overview, const std::string& posterImage)
		: m_title(title), m_runTimeInMinutes(runTimeInMinutes), m_genres(genres), m_overview(overview), m_posterImage(posterImage) {}
